...
static struct acpu_level acpu_freq_tbl_slow[] __initdata = {
    	...
    	{ 1, {   270000, HFPLL, 2, 0x20 }, L2(0),   900000 },
	...
	{ 1, {  1512000, HFPLL, 1, 0x3A }, L2(15), 1200000 },
#ifdef CONFIG_CPU_OVERCLOCK
	//{ 1, { 1620000, HFPLL, 1, 0x3C }, L2(16),  1250000 },
	{ 1, { 1728000, HFPLL, 1, 0x40 }, L2(16),  1300000 },
	{ 1, {  1836000, HFPLL, 1, 0x44 }, L2(16), 1305000 },
#endif
	{ 0, { 0 } }
};
static struct acpu_level acpu_freq_tbl_nom[] __initdata = {
    	{ 1, {   162000, PLL_8, 0, 0x00 }, L2(0),   825000 },
    	{ 1, {   270000, HFPLL, 2, 0x20 }, L2(0),   850000 },
	...
	{ 1, {  1836000, HFPLL, 1, 0x44 }, L2(16), 1255000 },
#endif
	{ 0, { 0 } }
};

static struct acpu_level acpu_freq_tbl_fast[] __initdata = {
    	{ 1, {   162000, PLL_8, 0, 0x00 }, L2(0),   775000 },
    	{ 1, {   270000, HFPLL, 2, 0x20 }, L2(0),   800000 },
...
static struct acpu_level acpu_freq_tbl_faster[] __initdata = {
    	...
    	//{ 1, {  1242000, HFPLL, 1, 0, 0x2E }, L2(16),  975000 },
    	//{ 0, {  1296000, HFPLL, 1, 0, 0x30 }, L2(16), 1000000 },
    	{ 1, {  1350000, HFPLL, 1, 0x34 }, L2(15), 1050000 },
    	//{ 0, {  1404000, HFPLL, 1, 0, 0x34 }, L2(16), 1012500 },
    	//{ 1, {  1458000, HFPLL, 1, 0, 0x36 }, L2(16), 1012500 },
    	{ 1, {  1512000, HFPLL, 1, 0x3A }, L2(15), 1075000 },
#ifdef CONFIG_CPU_OVERCLOCK
	//{ 1, { 1620000, HFPLL, 1, 0x3C }, L2(16), 1075000 },
	{ 1, { 1728000, HFPLL, 1, 0x40 }, L2(16), 1100000 },
	{ 1, {  1836000, HFPLL, 1, 0x44 }, L2(16), 1105000 },
#endif
    { 0, { 0 } }
};
