                ...
                struct kobj_attribute *attr, char *buf)
{
	...
	overtemp = min((int)msm_thermal_info.limit_temp_degC,
			(int)msm_thermal_info.core_limit_temp_degC);

	warning = min(((int)msm_thermal_info.limit_temp_degC -
	               (int)msm_thermal_info.temp_hysteresis_degC),
		      ((int)msm_thermal_info.core_limit_temp_degC -
		       (int)msm_thermal_info.core_temp_hysteresis_degC));
